...
public class FoodController {
    ...
    public ResponseEntity <?> updateFood (@RequestParam int id , String newFileUpdate , @RequestBody FoodDTO food){
        ResponeDataRes data = new ResponeDataRes();
        data.setData(foodServiceImp.updateFood(newFileUpdate , id , food) ? true : false);
        return new ResponseEntity<>(data , HttpStatus.OK);

    }

    @CacheEvict(value = "foodhome",allEntries = true)
